...
* HTTPS: ```git clone https://github.com/Microsoft/powerbi-visuals-utils-typeutils.git```
* SSH: ```git clone git@github.com:Microsoft/powerbi-visuals-utils-typeutils.git```

After that, you should change the current working directory to ```powerbi-visuals-utils-typeutils``` by using the following command:

```bash
cd powerbi-visuals-utils-typeutils
```
...
This command checks style of TypeScript code and provides a list of problems. Please address all of problems reported by TSLint before sending a pull request to the [repository](https://github.com/Microsoft/powerbi-visuals-utils-typeutils).
